...
export class QuizData {
    constructor(data) {
        this.questionsByPicture = [];
        this.questionsByAuthor = [];
        data.forEach((item, index) => {
            if(index < 120) {
            this.questionsByPicture.push(item);
            } 
            if(index >= 120) {
            this.questionsByAuthor.push(item);
            }
        })
        this.chunksQuestionsByPicture = this.arrayChunks(this.questionsByPicture, 10);
        this.chunksQuestionsByAuthor = this.arrayChunks(this.questionsByAuthor, 10);
    }
...
export class ArtistData {
    constructor() {
        this.data = new QuizData(images);
        this.artistQuestions = this.data.questionsByAuthor;
        this.chunksQuestionsByAuthor = this.data.chunksQuestionsByAuthor;
    }
}
...
export class PictureData {
    constructor() {
        this.data = new QuizData(images);
        this.pictureQuestions = this.data.questionsByPicture;
        this.chunksQuestionsByPicture = this.data.chunksQuestionsByPicture;
    }
}